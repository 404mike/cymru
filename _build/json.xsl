...
-->
       <xsl:template match="/">
           ...
           <xsl:element name="county">
               <xsl:element name="id"><xsl:value-of select="county/@id"/></xsl:element>
               ...
               <xsl:element name="population">
                   <xsl:element name="href"><xsl:value-of select="/county/population/@href" /></xsl:element>
                   <xsl:element name="_text"><xsl:value-of select="/county/population" /></xsl:element>
               </xsl:element>
               
               <xsl:for-each select="/county/about">
               ...
               <xsl:element name="poscodes">
                   <xsl:for-each select="/county/postcodes/postcode">
               ...
               <xsl:element name="towns">
                   <xsl:for-each select="/county/towns/town">
